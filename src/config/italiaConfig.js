  ...
  config.settings = {
    ...
    */
    ...
    siteProperties: {
      ...
      parentSiteTitle: 'Università degli studi di Bari Aldo Moro', //può essere una stringa, o un oggetto nel caso di multilingua: {'it':'Nome della Regione', 'en':'Region name'}.Se multilingua il default è comunque la stringa.
